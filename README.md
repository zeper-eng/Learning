...
![negative log-likelihood sum-exp form](https://latex.codecogs.com/svg.latex?J(B)=\sum_{i=1}^{n}\left[\log(1+e^{x_i^{T}B})-y_ix_i^{T}B\right]) (this form is the one I decided to implement)
